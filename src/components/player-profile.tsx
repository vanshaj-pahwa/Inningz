                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="text-right">200s</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {battingStats.map(stat => (
                                    <TableRow key={stat.format} className="even:bg-slate-50 dark:even:bg-gray-800/20">
                                        ...
                                        <TableCell className="text-right">{stat.notOuts}</TableCell>
                                        ...
                                        <TableCell className="text-right">{stat.doubleHundreds}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
                    ) : (
                        <p className="text-sm text-muted-foreground p-4">No batting statistics available</p>
                    )}
                </CardContent>
            </Card>
                            ...
                            <TableBody>
                                {bowlingStats.map(stat => (
                                    <TableRow key={stat.format} className="even:bg-slate-50 dark:even:bg-gray-800/20">
                                        ...
                                        <TableCell className="text-right">{stat.bbm}</TableCell>
                                        <TableCell className="text-right">{stat.average}</TableCell>
                                        <TableCell className="text-right">{stat.economy}</TableCell>
                                        <TableCell className="text-right">{stat.strikeRate}</TableCell>
                                        <TableCell className="text-right">{stat.fiveWickets}</TableCell>
                                        <TableCell className="text-right">{stat.tenWickets}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
                    ) : (
                        <p className="text-sm text-muted-foreground p-4">No bowling statistics available</p>
                    )}
                </CardContent>
            </Card>
